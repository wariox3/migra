...
class TurConcepto{
    ...
    public function migrar(){
        try{
            ...
            $totalDatos=$vanadio->query("SELECT COUNT(*) as 'numeroRegistro' FROM tur_concepto_servicio");
            $totalDatos->execute();
            ...
            while ($aux!==(int)$count) {
                ...
                horas_nocturnas,
                por_iva
                 FROM tur_concepto_servicio limit {$aux},{$limite}");
                $value="";
                ...
                if($value!=""){
                    $cromo->query("insert into tur_concepto(
                codigo_concepto_pk,
                nombre,
                horas,
                horas_diurnas,

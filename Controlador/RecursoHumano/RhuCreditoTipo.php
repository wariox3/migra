...
class RhuCreditoTipo{
    ...
    public function migrar(){
        try{
            ...
            $totalDatos=$vanadio->query("SELECT COUNT(*) as 'numeroRegistro' FROM rhu_credito_tipo");
            $totalDatos->execute();
            ...
            while ($aux!==(int)$count) {
                ...
                $datos = $vanadio->query("SELECT
                        ...
                        cupo_maximo,
                        codigo_pago_concepto_fk
                 FROM rhu_credito_tipo limit {$aux},{$limite}");
                $value="";
                ...
                if($value!=""){
                    $cromo->query("insert into rhu_credito_tipo(
                        codigo_credito_tipo_pk,
                        nombre,
                        cupo_maximo,
                        codigo_concepto_fk
